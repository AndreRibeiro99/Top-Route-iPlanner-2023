 ...
 *  @author Nate Liu
 */
public class DijkstraUndirectedSP_W2 {
     ...
     * other vertex in the edge-weighted graph_creator {@code G}.
     *
    ...
    public  DijkstraUndirectedSP_W2(EdgeWeightedGraph G, int s) {
        for (Edge e : G.edges()) {
            if (e.weight2() < 0)
    ...
    private void relaxW2(Edge e , int v) {
        int w = e.other(v);
        if (distTo[w] > distTo[v] + e.weight2()) {
            distTo[w] = distTo[v] + e.weight2();
            edgeTo[w] = e;
    ...
    private boolean check_W2(EdgeWeightedGraph G, int s) {
        ...
        for (int w = 0; w < G.V(); w++) {
            ...
            int v = e.other(w);
            if (distTo[v] + e.weight2() != distTo[w]) {
    ...
    public static void main(String[] args) {
        ...
        DijkstraUndirectedSP_W2 sp = new DijkstraUndirectedSP_W2(G, s);
